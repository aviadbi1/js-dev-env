...
This is used by webpack in the prod build only.
A seperate bundle for vendor code is useful since it's unlikely
to change as often as the app's code.
So all the libraries we reference here will be written to vendor.js
so they can be cached until one of them change.
So basically, this avoids customers having to download a huge JS file anytime 
a line of code changes. They only have to download vendor.js when
